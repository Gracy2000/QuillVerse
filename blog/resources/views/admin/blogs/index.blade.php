                    ...
                    @foreach ($blogs as $blog)
                        <tr>
                            ...
                            @if (auth()->user()->isAdmin())
                                <td>
                                    @if ($blog->visible)
                                        <button class="btn btn-danger" href="#" data-toggle="modal" data-target="#makeInvisibleModal" onClick="makeInvisibleModalHelper(' {{ route('admin.blogs.make-invisible', $blog->id) }} ')">Make Invisible</button>
                                    @else
                                        <button class="btn btn-primary" href="#" data-toggle="modal" data-target="#makeVisibleModal" onClick="makeVisibleModalHelper(' {{ route('admin.blogs.make-visible', $blog->id) }} ')">Make Visible</button>
                                    @endif
                                </td>
                            @endif
                        </tr>
